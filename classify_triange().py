...
Revised on Wednesday August 29 2018 for Homework01 in SSW567
...
class TestTriangles(unittest.TestCase):
    ...
    def testSet3(self):
        self.assertTrue(classifyTriangle(1, 1, 100), "NotATriangle")

if __name__ == '__main__':
    # examples of running the code
    runClassifyTriangle(1, 2, 3)
    runClassifyTriangle(1, 1, 1)
    runClassifyTriangle(10, 10, 20)
    runClassifyTriangle(3, 4, 5)
    runClassifyTriangle(1, 1, 100)
